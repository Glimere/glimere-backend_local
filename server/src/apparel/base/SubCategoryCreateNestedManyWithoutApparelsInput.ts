...
@InputType()
class SubCategoryCreateNestedManyWithoutApparelsInput {
...
export { SubCategoryCreateNestedManyWithoutApparelsInput as SubCategoryCreateNestedManyWithoutApparelsInput };
