...
@InputType()
class SubSubcategoryCreateNestedManyWithoutApparelsInput {
...
export { SubSubcategoryCreateNestedManyWithoutApparelsInput as SubSubcategoryCreateNestedManyWithoutApparelsInput };
