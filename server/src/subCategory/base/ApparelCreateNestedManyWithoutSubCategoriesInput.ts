...
@InputType()
class ApparelCreateNestedManyWithoutSubCategoriesInput {
...
export { ApparelCreateNestedManyWithoutSubCategoriesInput as ApparelCreateNestedManyWithoutSubCategoriesInput };
