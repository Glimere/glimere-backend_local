...
@InputType()
class MainCategoryCreateNestedManyWithoutSubCategoriesInput {
...
export { MainCategoryCreateNestedManyWithoutSubCategoriesInput as MainCategoryCreateNestedManyWithoutSubCategoriesInput };
