...
export class UserControllerBase {
  ...
  async findShippingAddress(
    ...
    const query = plainToClass(ShippingAddressFindManyArgs, request.query);
    const results = await this.service.findShippingAddress(params.id, {
      ...query,
      select: {
        addressName: true,
        city: true,
  ...
  @common.Post("/:id/shippingAddress")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async connectShippingAddress(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: ShippingAddressWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      shippingAddress: {
        connect: body,
  ...
  @common.Patch("/:id/shippingAddress")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  ...
  @common.Delete("/:id/shippingAddress")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectShippingAddress(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: ShippingAddressWhereUniqueInput[]
  ): Promise<void> {
    const data = {
