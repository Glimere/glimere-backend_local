...
export class WishlistControllerBase {
  ...
  async findWishlistItems(
    ...
    const results = await this.service.findWishlistItems(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/wishlistItems")
  @nestAccessControl.UseRoles({
    resource: "Wishlist",
    action: "update",
    possession: "any",
  })
  async connectWishlistItems(
    @common.Param() params: WishlistWhereUniqueInput,
  ...
  @common.Delete("/:id/wishlistItems")
  @nestAccessControl.UseRoles({
    resource: "Wishlist",
    action: "update",
    possession: "any",
  })
  async disconnectWishlistItems(
    @common.Param() params: WishlistWhereUniqueInput,
    @common.Body() body: WishlistItemsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
