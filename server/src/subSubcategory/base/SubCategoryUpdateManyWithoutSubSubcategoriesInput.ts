...
@InputType()
class SubCategoryUpdateManyWithoutSubSubcategoriesInput {
...
export { SubCategoryUpdateManyWithoutSubSubcategoriesInput as SubCategoryUpdateManyWithoutSubSubcategoriesInput };
