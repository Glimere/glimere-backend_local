...
@InputType()
class SubCategoryCreateNestedManyWithoutSubSubcategoriesInput {
...
export { SubCategoryCreateNestedManyWithoutSubSubcategoriesInput as SubCategoryCreateNestedManyWithoutSubSubcategoriesInput };
