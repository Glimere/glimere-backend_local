...
@InputType()
class ApparelCreateNestedManyWithoutApparelTypesInput {
...
export { ApparelCreateNestedManyWithoutApparelTypesInput as ApparelCreateNestedManyWithoutApparelTypesInput };
