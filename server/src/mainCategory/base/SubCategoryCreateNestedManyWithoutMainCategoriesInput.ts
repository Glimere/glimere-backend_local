...
@InputType()
class SubCategoryCreateNestedManyWithoutMainCategoriesInput {
...
export { SubCategoryCreateNestedManyWithoutMainCategoriesInput as SubCategoryCreateNestedManyWithoutMainCategoriesInput };
