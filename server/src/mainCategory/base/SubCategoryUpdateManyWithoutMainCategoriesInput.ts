...
@InputType()
class SubCategoryUpdateManyWithoutMainCategoriesInput {
...
export { SubCategoryUpdateManyWithoutMainCategoriesInput as SubCategoryUpdateManyWithoutMainCategoriesInput };
