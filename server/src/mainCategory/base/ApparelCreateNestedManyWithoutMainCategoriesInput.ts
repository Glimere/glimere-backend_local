...
@InputType()
class ApparelCreateNestedManyWithoutMainCategoriesInput {
...
export { ApparelCreateNestedManyWithoutMainCategoriesInput as ApparelCreateNestedManyWithoutMainCategoriesInput };
