...
@InputType()
class MeasurementCreateNestedManyWithoutSizingUnitsInput {
...
export { MeasurementCreateNestedManyWithoutSizingUnitsInput as MeasurementCreateNestedManyWithoutSizingUnitsInput };
